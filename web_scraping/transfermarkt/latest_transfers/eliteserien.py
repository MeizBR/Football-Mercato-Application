...
mycol = mydb["eliteserien-latest-transfers"]
...
def get_eliteserien_transfers(headers):
    rumours_url = "https://www.transfermarkt.com/transfers/neuestetransfers/statistik/plus/?plus=0&galerie=0&wettbewerb_id=NO1&verein_land_id=&selectedOptionInternalType=nothingSelected&land_id=&minMarktwert=500.000&maxMarktwert=500.000.000&minAbloese=0&maxAbloese=500.000.000&yt0=Show"
    ...
    for i,j,k,l in zip(player_details, country_details, player_fees, tmp):
        ...
        eliteserien_transfers.append(d)
        x = mycol.insert_one(d)
        logs.append(x.inserted_id)

    return eliteserien_transfers, logs
...
if __name__ == "__main__":
    ...
    transfer_data, logs = get_eliteserien_transfers(headers)
